...
- Timestamp: `2022-06-27 20:06`
- Build ID: `98fab8d0-57fe-4c7f-943b-234b810c0e1c`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/98fab8d0-57fe-4c7f-943b-234b810c0e1c.git
$ cd 98fab8d0-57fe-4c7f-943b-234b810c0e1c
```
